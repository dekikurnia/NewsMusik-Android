...
import co.newsmusik.adapter.AlbumAdapter;


public class AlbumActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String url = "http://api.newsmusik.co/albums";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.news) {
            Intent intent = new Intent(AlbumActivity.this, NewsActivity.class);
            startActivity(intent);
        }

        if (id == R.id.legend) {
            Intent intent = new Intent(AlbumActivity.this, LegendActivity.class);
            startActivity(intent);
        }

        if (id == R.id.interview) {
            Intent intent = new Intent(AlbumActivity.this, ExclusiveInterviewActivity.class);
            startActivity(intent);
        }

        if (id == R.id.story) {
            Intent intent = new Intent(AlbumActivity.this, ExclusiveStoryActivity.class);
            startActivity(intent);
        }

        if (id == R.id.male) {
            Intent intent = new Intent(AlbumActivity.this, MaleActivity.class);
            startActivity(intent);
        }

        if (id == R.id.female) {
            Intent intent = new Intent(AlbumActivity.this, FemaleActivity.class);
            startActivity(intent);
        }

        if (id == R.id.groupband) {
            Intent intent = new Intent(AlbumActivity.this, GroupBandActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.moviesandtv) {
            Intent intent = new Intent(AlbumActivity.this, MoviesAndTVActivity.class);
            startActivity(intent);
        }

        if (id == R.id.backstagestory) {
            Intent intent = new Intent(AlbumActivity.this, BackstageStoryActivity.class);
            startActivity(intent);
        }

        if (id == R.id.fashion) {
            Intent intent = new Intent(AlbumActivity.this, FashionActivity.class);
            startActivity(intent);
        }

        if (id == R.id.eventorganizer) {
            Intent intent = new Intent(AlbumActivity.this, EventOrganizerActivity.class);
            startActivity(intent);
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                adapter = new AlbumAdapter(AlbumActivity.this, feedItemList);
