...
import co.newsmusik.adapter.MaleAdapter;


public class MaleActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String url = "http://api.newsmusik.co/male";
    ...
    public void onBackPressed() {
        Intent intent = new Intent(MaleActivity.this, MainActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.news) {
            Intent intent = new Intent(MaleActivity.this, NewsActivity.class);
            startActivity(intent);
        }

        if (id == R.id.legend) {
            Intent intent = new Intent(MaleActivity.this, LegendActivity.class);
            startActivity(intent);
        }

        if (id == R.id.interview) {
            Intent intent = new Intent(MaleActivity.this, ExclusiveInterviewActivity.class);
            startActivity(intent);
        }

        if (id == R.id.story) {
            Intent intent = new Intent(MaleActivity.this, ExclusiveStoryActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.groupband) {
            Intent intent = new Intent(MaleActivity.this, GroupBandActivity.class);
            startActivity(intent);
        }

        if (id == R.id.album) {
            Intent intent = new Intent(MaleActivity.this, AlbumActivity.class);
            startActivity(intent);
        }

        if (id == R.id.moviesandtv) {
            Intent intent = new Intent(MaleActivity.this, MoviesAndTVActivity.class);
            startActivity(intent);
        }

        if (id == R.id.backstagestory) {
            Intent intent = new Intent(MaleActivity.this, BackstageStoryActivity.class);
            startActivity(intent);
        }

        if (id == R.id.fashion) {
            Intent intent = new Intent(MaleActivity.this, FashionActivity.class);
            startActivity(intent);
        }

        if (id == R.id.eventorganizer) {
            Intent intent = new Intent(MaleActivity.this, EventOrganizerActivity.class);
            startActivity(intent);
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPreExecute() {
            pd = new ProgressDialog(MaleActivity.this);
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                adapter = new MaleAdapter(MaleActivity.this, feedItemList);
