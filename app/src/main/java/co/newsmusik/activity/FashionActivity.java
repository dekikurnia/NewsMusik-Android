...
import co.newsmusik.adapter.FashionAdapter;


public class FashionActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String url = "http://api.newsmusik.co/fashion";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.news) {
            Intent intent = new Intent(FashionActivity.this, NewsActivity.class);
            startActivity(intent);
        }

        if (id == R.id.legend) {
            Intent intent = new Intent(FashionActivity.this, LegendActivity.class);
            startActivity(intent);
        }

        if (id == R.id.interview) {
            Intent intent = new Intent(FashionActivity.this, ExclusiveInterviewActivity.class);
            startActivity(intent);
        }

        if (id == R.id.story) {
            Intent intent = new Intent(FashionActivity.this, ExclusiveStoryActivity.class);
            startActivity(intent);
        }

        if (id == R.id.male) {
            Intent intent = new Intent(FashionActivity.this, MaleActivity.class);
            startActivity(intent);
        }

        if (id == R.id.female) {
            Intent intent = new Intent(FashionActivity.this, FemaleActivity.class);
            startActivity(intent);
        }

        if (id == R.id.groupband) {
            Intent intent = new Intent(FashionActivity.this, GroupBandActivity.class);
            startActivity(intent);
        }

        if (id == R.id.album) {
            Intent intent = new Intent(FashionActivity.this, AlbumActivity.class);
            startActivity(intent);
        }

        if (id == R.id.moviesandtv) {
            Intent intent = new Intent(FashionActivity.this, MoviesAndTVActivity.class);
            startActivity(intent);
        }

        if (id == R.id.backstagestory) {
            Intent intent = new Intent(FashionActivity.this, BackstageStoryActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.eventorganizer) {
            Intent intent = new Intent(FashionActivity.this, EventOrganizerActivity.class);
            startActivity(intent);
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPreExecute() {
            pd = new ProgressDialog(FashionActivity.this);
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                adapter = new FashionAdapter(FashionActivity.this, feedItemList);
