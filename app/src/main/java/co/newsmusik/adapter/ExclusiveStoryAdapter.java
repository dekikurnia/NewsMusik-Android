 ...
 */
public class ExclusiveStoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ExclusiveStoryAdapter(Context context, List<FeedItem> feedItemList) {
        this.feedItemList = feedItemList;
        this.mContext = context;
    }

    public ExclusiveStoryAdapter() {
