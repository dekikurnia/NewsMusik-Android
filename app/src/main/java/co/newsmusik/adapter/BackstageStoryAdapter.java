 ...
 */
public class BackstageStoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BackstageStoryAdapter(Context context, List<FeedItem> feedItemList) {
        this.feedItemList = feedItemList;
        this.mContext = context;
    }

    public BackstageStoryAdapter() {
