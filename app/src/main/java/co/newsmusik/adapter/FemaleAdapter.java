 ...
 */
public class FemaleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FemaleAdapter(Context context, List<FeedItem> feedItemList) {
        this.feedItemList = feedItemList;
        this.mContext = context;
    }

    public FemaleAdapter() {
