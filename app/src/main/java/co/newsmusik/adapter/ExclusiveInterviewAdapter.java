 ...
 */
public class ExclusiveInterviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ExclusiveInterviewAdapter(Context context, List<FeedItem> feedItemList) {
        this.feedItemList = feedItemList;
        this.mContext = context;
    }

    public ExclusiveInterviewAdapter() {
