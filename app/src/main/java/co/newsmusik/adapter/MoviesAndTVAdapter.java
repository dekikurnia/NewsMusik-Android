 ...
 */
public class MoviesAndTVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MoviesAndTVAdapter(Context context, List<FeedItem> feedItemList) {
        this.feedItemList = feedItemList;
        this.mContext = context;
    }

    public MoviesAndTVAdapter() {
