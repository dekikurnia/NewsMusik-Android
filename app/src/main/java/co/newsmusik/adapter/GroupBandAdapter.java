 ...
 */
public class GroupBandAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GroupBandAdapter(Context context, List<FeedItem> feedItemList) {
        this.feedItemList = feedItemList;
        this.mContext = context;
    }

    public GroupBandAdapter() {
